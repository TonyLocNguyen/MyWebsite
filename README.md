  ...
  <section class="page-section" id="services">
    <div class="container">
      <div class="row">
		...
		<div style="background-image: url('me.jpg');">
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#portfolioModal1">
            ...
            <img class="img-fluid" src="img/portfolio/requirements-icon.jpg" alt="">
          </a>
          <div class="portfolio-caption">
            <h4>Requiement</h4>
            <p class="text-muted">Requiement</p>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#portfolioModal2">
            ...
            <img class="img-fluid" src="img/portfolio/design-word-concept_23-2147844787.jpg" alt="">
          </a>
          <div class="portfolio-caption">
            <h4>Design</h4>
        ...
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#portfolioModal3">
            ...
            <img class="img-fluid" src="img/portfolio/implement-2372179_960_720.jpg" alt="">
          </a>
          <div class="portfolio-caption">
            <h4>Implement</h4>
  ...
  <footer class="footer">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-4">
          <span class="copyright">Nong Lam University</span>
        </div>
        <div class="col-md-4">
          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="modal-body">
                ...
                <img class="img-fluid d-block mx-auto" src="img/portfolio/requirements-icon.jpg" alt="">
